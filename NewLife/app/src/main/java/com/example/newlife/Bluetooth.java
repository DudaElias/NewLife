...
public class Bluetooth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(Bluetooth.this, "Recebendo dados do Bluetooth", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
            ...
            public void run() {
                while (!Thread.currentThread().isInterrupted() && !stopWorker) {
                    try {
                        ...
                        Toast.makeText(Bluetooth.this, "Mensagem recebida: " + info, Toast.LENGTH_SHORT).show();
